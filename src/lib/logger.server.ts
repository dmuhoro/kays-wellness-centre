...
export const EVENTS = {
  ...
  RETENTION_TASK_SCHEDULED: "RETENTION_TASK_SCHEDULED",
  RETENTION_TASK_SENT: "RETENTION_TASK_SENT",
  RETENTION_CAMPAIGN_GENERATED: "RETENTION_CAMPAIGN_GENERATED",
  SATISFACTION_PROMPT_SENT: "SATISFACTION_PROMPT_SENT",
  FEEDBACK_RECEIVED: "FEEDBACK_RECEIVED",
  REVIEW_AUTO_SUBMITTED: "REVIEW_AUTO_SUBMITTED",
  REVIEW_GUARD_CONFIGURED: "REVIEW_GUARD_CONFIGURED",
} as const;
