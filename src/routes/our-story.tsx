  ...
  head: () => ({
    meta: [
      { title: "Our Story — Dr. Jacqueline Mwanu | Kay's Wellness Centre" },
      {
        name: "description",
        content:
          "Meet Dr. Jacqueline Mwanu (MD, MBChB, MPH, IHDiP) — Public Health Physician and Functional & Integrative Medicine Specialist shifting the culture of healthcare across Africa.",
      },
      { property: "og:title", content: "Our Story — Kay's Wellness Centre" },
      {
        property: "og:description",
        content: "Evidence-based, root-cause, holistic care led by Dr. Jacqueline Mwanu.",
      },
    ],
  }),
  component: OurStory,
...
const values = [
  {
    ...
    desc: "Modern functional diagnostics and peer-reviewed protocols guide every decision.",
  },
  {
    icon: HeartHandshake,
    title: "Affordable Access",
    desc: "Premium holistic care, structured to remain accessible to our community.",
  },
  {
    icon: Sparkles,
    title: "Holistic Healing",
    desc: "We treat the whole person — body, mind, lifestyle and environment.",
  },
  {
    icon: Award,
    title: "Trust & Innovation",
    desc: "Long-term relationships built on integrity and continuous learning.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div className="animate-fade-up">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold tracking-tight">
                Dr. Jacqueline <span className="text-gradient">Mwanu, MD, MBChB, MPH, IHDiP</span>
              </h1>
              <p className="mt-2 text-lg font-medium text-primary">
                Public Health Physician & Functional/Integrative Medicine Specialist
              </p>
              <div className="mt-5 flex flex-wrap gap-2">
                {credentials.map((c) => (
                  <span
                    key={c.label}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-secondary border-warm text-xs font-semibold text-primary"
                  >
              ...
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                Dr. Jacqueline Mwanu founded Kay's Wellness Centre on a single conviction: chronic
                disease should be <em>prevented and reversed where possible</em> — not endlessly
                managed. Trained in both rigorous clinical medicine and public-health systems
                thinking, she brings a whole-person, whole-system lens to every patient she sees.
              </p>
              <p className="mt-4 text-muted-foreground leading-relaxed">
                From hormonal imbalance and digestive disorders to autoimmune and metabolic
                conditions, her work looks beyond symptoms to uncover root causes — and builds
                personalised, sustainable plans that respect each patient's life, culture and
                community.
              </p>
            </div>
            <div className="relative animate-scale-in">
              ...
              <img
                src={drJackie}
                alt="Dr. Jacqueline Mwanu, MD, MBChB, MPH, IHDiP"
              ...
              <div className="absolute -bottom-6 left-6 right-6 glass rounded-2xl p-5 border-warm">
                ...
                <p className="text-sm mt-2 leading-relaxed italic">
                  "Moving from Firefighting Illness to Striving for True Wellness — one patient, one
          ...
          <div className="relative overflow-hidden rounded-3xl gradient-hero p-10 sm:p-16 text-primary-foreground shadow-elegant">
            ...
            <div className="relative max-w-3xl">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">
                Shifting the culture of healthcare.
              </h2>
              <p className="mt-5 text-lg text-primary-foreground/90 leading-relaxed">
                Across Kenya and the African continent, healthcare has long been reactive — waiting
                for crisis. Dr. Jacqueline's mission is to change that culture. To move patients,
                families and entire communities toward proactive, empowered, root-cause
                health-seeking habits.
              </p>
              <p className="mt-4 text-primary-foreground/80 leading-relaxed">
                It is a worldview built on global public-health rigour and lived African experience:
                prevention before treatment, education before prescription, dignity before
                diagnosis.
              </p>
              <div className="mt-8 grid sm:grid-cols-3 gap-4">
                {[
                  ...
                  <div
                    key={s.k}
                    className="rounded-2xl bg-primary-foreground/10 backdrop-blur p-4 border border-primary-foreground/15"
                  >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v, i) => (
              <div
                key={v.title}
                className="glass rounded-2xl p-7 card-lift animate-fade-up border-warm"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {team.map((t, i) => (
              <div
                key={t.name}
                className="rounded-2xl overflow-hidden card-lift glass animate-fade-up border-warm"
